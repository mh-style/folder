...
;(function($, window, document, undefined) {
	...
	mh.prototype.trigger = function(name, data, namespace, state, enter) {
		var status = {
			...
			[ name, 'mh', namespace || 'carousel' ].join('.').toLowerCase(),
	...
	/**
	 * The jQuery Plugin for the mh Carousel
	 * @todo Navigation plugin `next` and `prev`
	 * @public
	 */
	$.fn.mhCarousel = function(option) {
		var args = Array.prototype.slice.call(arguments, 1);

		return this.each(function() {
			var $this = $(this),
				data = $this.data('mh.carousel');

			if (!data) {
				data = new mh(this, typeof option == 'object' && option);
				$this.data('mh.carousel', data);

				$.each([
					'next', 'prev', 'to', 'destroy', 'refresh', 'replace', 'add', 'remove'
				], function(i, event) {
					data.register({ type: mh.Type.Event, name: event });
					data.$element.on(event + '.mh.carousel.core', $.proxy(function(e) {
...
;(function($, window, document, undefined) {
	 ...
	 * @param {mh} carousel - The mh Carousel
	 */
	var AutoRefresh = function(carousel) {
		 ...
		 */
		this._handlers = {
			'initialized.mh.carousel': $.proxy(function(e) {
	...
	$.fn.mhCarousel.Constructor.Plugins.AutoRefresh = AutoRefresh;
...
;(function($, window, document, undefined) {
	...
	var Lazy = function(carousel) {
		 ...
		 */
		this._handlers = {
			'initialized.mh.carousel change.mh.carousel resized.mh.carousel': $.proxy(function(e) {
				if (!e.namespace) {
					return;
				}
	...
	$.fn.mhCarousel.Constructor.Plugins.Lazy = Lazy;
...
;(function($, window, document, undefined) {
	...
	var AutoHeight = function(carousel) {
		 ...
		 */
		this._handlers = {
			'initialized.mh.carousel refreshed.mh.carousel': $.proxy(function(e) {
				if (e.namespace && this._core.settings.autoHeight) {
					this.update();
				}
			}, this),
			'changed.mh.carousel': $.proxy(function(e) {
	...
	$.fn.mhCarousel.Constructor.Plugins.AutoHeight = AutoHeight;
...
;(function($, window, document, undefined) {
	...
	var Video = function(carousel) {
		...
		this._handlers = {
			...
			'resize.mh.carousel': $.proxy(function(e) {
				if (e.namespace && this._core.settings.video && this.isInFullScreen()) {
					e.preventDefault();
				}
			}, this),
			'refreshed.mh.carousel': $.proxy(function(e) {
			...
			'prepared.mh.carousel': $.proxy(function(e) {
				if (!e.namespace) {
					return;
				}
	...
	$.fn.mhCarousel.Constructor.Plugins.Video = Video;
...
;(function($, window, document, undefined) {
	 ...
	 * @param {mh} scope - The mh Carousel
	 */
	var Animate = function(scope) {
		...
		this.handlers = {
			'change.mh.carousel': $.proxy(function(e) {
				if (e.namespace && e.property.name == 'position') {
					this.previous = this.core.current();
					this.next = e.property.value;
				}
			}, this),
			'drag.mh.carousel dragged.mh.carousel translated.mh.carousel': $.proxy(function(e) {
				if (e.namespace) {
					this.swapping = e.type == 'translated';
				}
			}, this),
			'translate.mh.carousel': $.proxy(function(e) {
	...
	$.fn.mhCarousel.Constructor.Plugins.Animate = Animate;
...
;(function($, window, document, undefined) {
	...
	$.fn.mhCarousel.Constructor.Plugins.autoplay = Autoplay;
...
;(function($, window, document, undefined) {
	...
	var Navigation = function(carousel) {
		...
		this._handlers = {
			...
			'added.mh.carousel': $.proxy(function(e) {
				if (e.namespace && this._core.settings.dotsData) {
					this._templates.splice(e.position, 0, this._templates.pop());
				}
			}, this),
			'remove.mh.carousel': $.proxy(function(e) {
				if (e.namespace && this._core.settings.dotsData) {
	...
	$.fn.mhCarousel.Constructor.Plugins.Navigation = Navigation;
...
;(function($, window, document, undefined) {
	...
	$.fn.mhCarousel.Constructor.Plugins.Hash = Hash;
